...
The class exposes the same interface as :class:`~hod_mod.galaxies.agn.XrayAGNModel`
so it plugs into :class:`~hod_mod.galaxies.cross_spectra.HaloModelCrossSpectra`
...
class HamAGNModel:
    ...
    def agn_emissivity_uk(
        ...
        *,
        ...
        :meth:`~hod_mod.galaxies.agn.XrayAGNModel.agn_emissivity_uk`.
