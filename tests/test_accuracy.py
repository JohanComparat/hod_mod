...
class TestNFWProfilesAccuracy:
    ...
    def test_nfw_rho_inner_slope(self):
        ...
        from hod_mod.cosmology.halo_profiles import nfw_rho
    ...
    def test_nfw_mass_vs_numerical_integration(self):
        ...
        from hod_mod.cosmology.halo_profiles import nfw_rho, nfw_mass
    ...
    def test_nfw_mean_sigma_vs_numerical_integration(self):
        ...
        from hod_mod.cosmology.halo_profiles import nfw_sigma, nfw_mean_sigma
    ...
    def test_nfw_delta_sigma_identity(self):
        ...
        from hod_mod.cosmology.halo_profiles import nfw_sigma, nfw_mean_sigma, nfw_delta_sigma
    ...
    def test_einasto_rho_at_scale_radius(self):
        ...
        from hod_mod.cosmology.halo_profiles import einasto_rho
    ...
    def test_einasto_uk_k0_limit(self):
        """Einasto û(k → 0) → 1."""
        from hod_mod.cosmology.halo_profiles import einasto_uk
...
class TestDistancesAccuracy:
    ...
    def test_hubble_e_z0_equals_one(self):
        ...
        from hod_mod.cosmology.distances import hubble_e
    ...
    def test_angular_diameter_distance_identity(self):
        """d_A(z) = χ(z) / (1 + z)."""
        from hod_mod.cosmology.distances import comoving_distance, angular_diameter_distance
    ...
    def test_luminosity_distance_identity(self):
        """d_L(z) = χ(z) * (1 + z)."""
        from hod_mod.cosmology.distances import comoving_distance, luminosity_distance
        z = jnp.array([0.3, 0.5, 1.0, 2.0])
        chi = np.asarray(comoving_distance(z, self._H, self._OM))
    ...
    def test_etherington_relation(self):
        ...
        from hod_mod.cosmology.distances import angular_diameter_distance, luminosity_distance
    ...
    def test_distance_modulus_consistency(self):
        ...
        from hod_mod.cosmology.distances import luminosity_distance, distance_modulus
...
class TestEisensteinHuPkAccuracy:
    ...
    def test_shape_agreement_with_camb(self):
        ...
        from hod_mod.cosmology.power_spectrum import eisenstein_hu_pk, LinearPowerSpectrum
...
class TestHaloMassFunctionAccuracy:
    ...
    def test_delta_vir_eds_limit(self):
        ...
        from hod_mod.cosmology.halo_mass_function import delta_vir_flat_jax
    ...
    def test_fsigma_tinker08_at_sigma1(self):
        ...
        """
        from hod_mod.cosmology.halo_mass_function import fsigma_tinker08
    ...
    def test_tinker10_bias_near_unity_at_nu1(self):
        ...
        from hod_mod.cosmology.halo_mass_function import tinker10_bias
...
class TestHODAccuracy:
    ...
    def test_nsat_zero_below_m0(self):
        ...
        from hod_mod.galaxies.hod import n_sat
        p = self._HOD_PARAMS
        val = float(n_sat(
    ...
    def test_f_quenched_low_mass_limit(self):
        ...
        from hod_mod.galaxies.hod import f_quenched
    ...
    def test_f_red_cen_saturates(self):
        ...
        from hod_mod.galaxies.hod import f_red_cen_zu16
    ...
    def test_f_red_sat_saturates(self):
        ...
        from hod_mod.galaxies.hod import f_red_sat_zu16
    ...
    def test_sigma_lnmstar_positive(self):
        ...
        from hod_mod.galaxies.hod import sigma_lnmstar_zu15
    ...
    def test_shmr_guo18_monotone(self):
        ...
        from hod_mod.galaxies.hod import shmr_guo18
        log10m = jnp.linspace(11.0, 15.0, 100)
    ...
    def test_shmr_zacharegkas25_monotone(self):
        ...
        from hod_mod.galaxies.hod import shmr_zacharegkas25
        log10m = jnp.linspace(11.0, 15.0, 100)
    ...
    def test_n_cen_thresh_zu15_range(self):
        ...
        from hod_mod.galaxies.hod import n_cen_thresh_zu15
...
class TestSHAMAccuracy:
    ...
    def test_behroozi13_mstar_below_mhalo(self):
        ...
        from hod_mod.galaxies.sham import smhm_behroozi13
    ...
    def test_girelli20_mstar_below_mhalo(self):
        ...
        from hod_mod.galaxies.sham import smhm_girelli20
