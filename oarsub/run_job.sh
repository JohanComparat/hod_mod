...
# dahu (/home/comparaj).  Resources (cores / walltime) come from the `-l` flag
...
# --- environment ------------------------------------------------------------
export MAMBA_EXE="${MAMBA_EXE:-/home/comparaj/miniforge3/bin/mamba}"
export MAMBA_ROOT_PREFIX="${MAMBA_ROOT_PREFIX:-/home/comparaj/miniforge3}"
