#!/usr/bin/env bash
# =============================================================================
# GRICAD / OAR job: Comparat+2025 fixed-ZM15 X-ray fit — S1, MAP, gas-temp.
#
...
#
# Submit:  oarsub --project your-oar-project -S ./oarsub/fit_comparat2025_gas_temp.sh
...
#OAR --stderr oarsub/logs/%jobid%.c2025_gas_temp.err
...
#   oarsub --project P -S "./oarsub/fit_comparat2025_gas_temp.sh v0.3"
VTAG="${1:-${VTAG:-v0.4}}"
...
OUT_DIR="${HOD_MOD_RESULTS}/fits/comparat2025_fixedZM15_gas-temp${ECF_SUFFIX}_${VTAG}"
...
python -m hod_mod.scripts.fitting.fit_comparat2025 \
    ...
    --free-params gas-temp --agn-model hod ${ECF_FLAG} \
    --out-dir "${OUT_DIR}"
