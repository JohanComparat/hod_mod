...
#
# Submit:  oarsub --project your-oar-project -S ./oarsub/fit_comparat2025_gas_full.sh
# Smoke:   oarsub -t devel -S ./oarsub/fit_comparat2025_gas_full.sh    (<=30 min)
# =============================================================================

#OAR --name c2025_gas_full
...
#   oarsub --project P -S "./oarsub/fit_comparat2025_gas_full.sh v0.3"
VTAG="${1:-${VTAG:-v0.4}}"
...
OUT_DIR="${HOD_MOD_RESULTS}/fits/comparat2025_fixedZM15_gas-full${ECF_SUFFIX}_${VTAG}"
...
python -m hod_mod.scripts.fitting.fit_comparat2025 \
    ...
    --free-params gas-full --agn-model hod ${ECF_FLAG} \
    --out-dir "${OUT_DIR}"
