...
# already sets ProxyJump, or set to e.g. your-cluster-login@access-gricad.univ-grenoble-alpes.fr
BASTION="${BASTION:-your-cluster-login@access-gricad.univ-grenoble-alpes.fr}"
